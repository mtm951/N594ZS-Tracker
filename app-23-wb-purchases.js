...
function savePurchase(id){
  ...
  if(typeof window.reconcilePurchaseLinks==='function')window.reconcilePurchaseLinks(obj,{createPart:['On Hand','Installed'].includes(obj.disposition),createEquipment:obj.trackAsEquipment});
