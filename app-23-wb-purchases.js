...
function savePurchase(id){
  ...
  if(typeof window.reconcilePurchaseLinks==='function')window.reconcilePurchaseLinks(obj,{createPart:obj.disposition==='On Hand'||obj.inventoryApplied,createEquipment:obj.trackAsEquipment});
