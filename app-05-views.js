...
function renderOrders(){
  document.getElementById('page-orders').innerHTML=`<div class="card"><div class="toolbar"><div><h1>Orders</h1><div class="muted">Central purchase queue. Link an order to multiple projects and/or one inventory part, then track vendor, price, shipping, ETA, receipt and blockers.</div></div><button class="btn primary" onclick="openOrderModal()">+ Add Order</button></div>
