...
function renderOrders(){
  ...
  <div class="controls"><input id="orderSearch" placeholder="Search orders…" oninput="renderOrderRows()"><select id="orderStatus" onchange="renderOrderRows()"><option value="">All statuses</option><option value="Open">Open (all active orders)</option><option>Need to Order</option><option>Quoted</option><option>Ordered</option><option>Backordered</option><option>Received</option><option>Cancelled</option></select><select id="orderSystem" onchange="renderOrderRows()">${trackerSystemFilterOptions('')}</select></div>
