...
async function remoteRows(){const types=typeof SYNC_RECORD_TYPES!=='undefined'?[...SYNC_RECORD_TYPES]:['aircraft','settings','project','part','order','log','document','checklist','maintenance','purchase'];return cloudReadAllTrackerRecords({columns:'record_type,record_id,data,deleted_at,updated_at,updated_client,record_version',types});}
