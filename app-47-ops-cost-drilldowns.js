...
(function(){
  ...
  style.textContent='#page-ops .ops-cost-clickable{cursor:pointer;transition:background .12s ease,border-color .12s ease,transform .12s ease}#page-ops .ops-cost-clickable:hover{background:#f7fbff;transform:translateY(-1px)}#page-ops .ops-cost-clickable:focus{outline:3px solid rgba(30,115,180,.22);outline-offset:2px}#page-ops .cost-list .ops-cost-clickable:after,#page-ops .cost-breakdown .ops-cost-clickable:after{content:"›";margin-left:8px;opacity:.38;font-weight:800}#page-ops .cost-list .ops-cost-clickable{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(105px,145px);align-items:center;column-gap:14px;width:100%;min-width:0;position:relative;padding-right:22px;box-sizing:border-box}#page-ops .cost-list .ops-cost-clickable>span{min-width:0;text-align:left;justify-self:start}#page-ops .cost-list .ops-cost-clickable>b{justify-self:stretch;text-align:right;white-space:nowrap;font-variant-numeric:tabular-nums}#page-ops .cost-list .ops-cost-clickable:after{position:absolute;right:2px;top:50%;transform:translateY(-50%);width:12px;text-align:right;margin-left:0}#page-ops .cost-hero .ops-cost-clickable:after{content:"View details ›";display:block;font-size:10px;font-weight:700;opacity:.5;margin-top:5px}';
